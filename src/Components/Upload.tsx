...
async function uploadMetadata(metaData : Array<any>){
...
taxCode: string,) {
  ...
  props.client.models.Todo.create({ barcode: barcode, vendorName: vendorName, invoiceDate: invoiceDate, entryDate: entryDate, taxCode: taxCode, url:  url });
}
